...
import numpy as np
scalarobject=bz2.BZ2File('C:/Users/dell1/Patients Condition Prediction Model/standardScalar.pkl', 'rb')
scaler=pickle.load(scalarobject)
modelforpred = bz2.BZ2File("C:/Users/dell1/Patients Condition Prediction Model/modelForPrediction.pkl", "rb")
